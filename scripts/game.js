import { getId, Stat, Item, shuffle, DeathCause, RelationType, Perk, Creature, randomColor } from "./globals.js";
export class Game {
    static round = 0;
    static pups = [];
    static relations = [];
    static actionPool = [
        ...
        { pups: 1, text: "[0] just wants this all to be over.", chance: 0.1, bias: t => t[0].bias(Stat.energy, -0.1), req: t => !t[0].perks.includes(Perk.suicidal), effect: t => { if (Math.random() < 0.5)
                t[0].perks.push(Perk.suicidal); } },
